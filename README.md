...
Current stable release is 1.1.2.

#### Maven coordinates

| Group ID    | Artifact ID | Version |
| :---------: | :---------: | :-----: |
| org.reactfx | reactfx     | 1.1.2   |

#### Gradle example

```groovy
dependencies {
    compile group: 'org.reactfx', name: 'reactfx', version: '1.1.2'
}
```
...
```scala
libraryDependencies += "org.reactfx" % "reactfx" % "1.1.2"
```

#### Manual download

[Download](https://github.com/TomasMikula/ReactFX/releases/download/v1.1.2/reactfx-1.1.2.jar) the JAR file and place it on your classpath.
...
| Group ID    | Artifact ID | Version        |
| :---------: | :---------: | :------------: |
| org.reactfx | reactfx     | 1.1.3-SNAPSHOT |
...
dependencies {
    compile group: 'org.reactfx', name: 'reactfx', version: '1.1.3-SNAPSHOT'
}
```
...
libraryDependencies += "org.reactfx" % "reactfx" % "1.1.3-SNAPSHOT"
```

#### Manual download

[Download](https://oss.sonatype.org/content/repositories/snapshots/org/reactfx/reactfx/1.1.3-SNAPSHOT/) the latest JAR file and place it on your classpath.
